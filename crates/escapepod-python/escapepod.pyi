...
class Reader:
    ...
    def get_signal(
        self, read: ReadData, max_samples: Optional[int] = None
    ) -> npt.NDArray[np.int16]: ...
    def get_signal_pa(
        self, read: ReadData, max_samples: Optional[int] = None
    ) -> npt.NDArray[np.float32]: ...
    def get_signals(
        self, reads: list[ReadData], max_samples: Optional[int] = None
    ...
    def annotation(self, name: Optional[str] = None) -> dict[str, str]: ...
    def score_names(self) -> list[str]: ...
    def score(self, name: str) -> dict[str, float]: ...
    def design(self) -> Optional[dict[str, Any]]: ...
...
class AnchoredReads:
    ...
    @property
    def orientation_votes(self) -> tuple[int, int]: ...
    def index_pod5(self, paths: list[Union[str, PathLike[str]]]) -> int: ...
    def storage_order(self, read_ids: list[str]) -> list[str]: ...
    def load_kmer_table(
        self,
        path: Union[str, PathLike[str]],
...
def refine_signal_map(
    ...
    scale_iters: int = 2,
    dwell_target: Optional[float] = None,
